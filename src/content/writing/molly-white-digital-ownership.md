...
This quote jumps out at me because of how it chimes with the more expansive definition used in [Local-first Software]("./local-first-software.md"), which in turn had resonated with the 'hacker' class concept that Mackenzie Wark proposes in [Capital is Dead]('./capital-is-dead.md'). This might be a topic to extract into a separate note.
